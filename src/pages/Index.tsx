...
<section id="features" className="py-16 bg-white">
  <div className="container mx-auto px-4">
    <div className="text-center mb-16">
      <h2 className="text-3xl font-bold mb-4">All-in-One Marketing Solution</h2>
      <p className="text-gray-600 max-w-2xl mx-auto">
        MarketerOS AI combines five powerful modules to handle all aspects of your marketing workflow.
      </p>
    </div>
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <div className="bg-gray-50 rounded-lg p-6 border border-gray-100">
        ...
        <h3 className="text-lg font-semibold mb-2">AI Shopping Assistant</h3>
        <p className="text-gray-600">
          Engage shoppers with an AI-powered chat interface that answers questions, provides product recommendations, and offers personalized discounts.
        </p>
      </div>
      <div className="bg-gray-50 rounded-lg p-6 border border-gray-100">
        ...
        <h3 className="text-lg font-semibold mb-2">AI Business Buddy</h3>
        <p className="text-gray-600">
          Get AI assistance with store setup, content generation, campaign launches, and customer support configurations.
        </p>
      </div>
      <div className="bg-gray-50 rounded-lg p-6 border border-gray-100">
        ...
        <h3 className="text-lg font-semibold mb-2">Kwik Ads++</h3>
        <p className="text-gray-600">
          Create high-converting ad campaigns with audience segmentation, creative generation, and performance analytics.
        </p>
      </div>
      <div className="bg-gray-50 rounded-lg p-6 border border-gray-100">
        ...
        <h3 className="text-lg font-semibold mb-2">CRM Co-Pilot</h3>
        <p className="text-gray-600">
          Manage customer segments, build multi-channel campaigns, and optimize message templates with AI assistance.
        </p>
      </div>
      <div className="bg-gray-50 rounded-lg p-6 border border-gray-100">
        ...
        <h3 className="text-lg font-semibold mb-2">AI Landing Lab</h3>
        <p className="text-gray-600">
          Build high-converting landing pages with AI-generated content, dynamic templates, and performance optimization.
        </p>
      </div>
      <div className="bg-gray-50 rounded-lg p-6 border border-gray-100">
        ...
        <p className="text-gray-600">
          Unified analytics across all marketing efforts with AI-powered insights and recommendations.
        </p>
      </div>
    </div>
  </div>
            ...
            <Card className="animate-on-scroll opacity-0 border-yale-blue border-2 relative shadow-xl flex flex-col h-full" style={{ animationDelay: "0.2s", transform: 'scale(1.03)' }}>
              ...
              <CardHeader className="pt-10">
                ...
                <CardDescription>Monthly subscription</CardDescription>
                 <div className="mt-4">
                  <span className="text-4xl font-bold text-oxford-blue">$149</span>
